...
Real-device SDK 54 observation: external_pending — server and QR code are live, but the user has not yet reported the compatible-client screen or rendered product shell
