...
| Local-private | Course answers and progress, saved expression cards, privacy settings, chosen form of address, local 18+ declaration | iOS SQLCipher database only | Retained until per-record deletion or Delete All Data. A save is a distinct user action. No cloud sync. |
